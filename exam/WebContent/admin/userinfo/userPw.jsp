        ...
        <script language="javascript">
            function check()
            {
                 ...
                 var userType="${sessionScope.userType}";
	                 if("${sessionScope.userType}"=="0")
	                 {
	                     userPwReal="${sessionScope.admin.userPw}";
	                 }else if("${sessionScope.userType}"=="1")
	                 {
	                     userPwReal="${sessionScope.tea.loginPw}";
	                 }else if("${sessionScope.userType}"=="2")
	                 {
	                     userPwReal="${sessionScope.stu.loginPw}";
	                 } 
